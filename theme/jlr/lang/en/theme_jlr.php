...
$string['choosereadme'] = '<p>Jlr is a theme that allows you to easily customise Moodle\'s look and feel directly from the web interface.</p>
<p>Visit the admin settings to change colours, add an image as a background, add your logo and jlr.</p>';

$string['configtitle'] = 'Jlr';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'The logo is only displayed in the header of the front page and login page.<br /> If the height of your logo is jlr than 75px add div.logo {height: 100px;} to the Custom CSS box below, amending accordingly if the height is other than 100px. If a logo is not added here, the logo in Appearance > Logos will be used.';

$string['pluginname'] = 'mygr8theme';
...
$string['footertextcolor_desc'] = 'Text color of the footer, located on the bottom of the screen.';
$string['h2textcolor'] = 'h2 Text Color';
$string['h2textcolor_desc'] = 'This will change the color of every h2 tag';
$string['phovercolor'] = 'p hover color';
$string['phovercolor_desc'] = 'This will change the color of every p tag';
$string['fontsize'] = 'font size';
$string['fontsize_desc'] = 'This will change the font size';
